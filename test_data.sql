...
--People
INSERT INTO people (id, name, position, age, country) VALUES (1, 'Путин, Владимир Владимирович', 'Президент', 68, 'Россия');
INSERT INTO people (id, name, position, age, country) VALUES (2, 'Байден, Джо', 'Президент', 77, 'США');
