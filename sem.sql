CREATE TYPE TAG AS ENUM ('США', 'Китай', 'Россия', 'Украина', 'Северная Корея', 'Япония', 'Беларусь', 'ООН', 'ЕС', 'Сирия', 'Турция');--TODO add more
...
INSERT INTO tags_people VALUES (3, 'Китай');
